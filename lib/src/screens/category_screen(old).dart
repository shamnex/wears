...
class CategoryGrid {
  Widget buildItem(String name, String price, String imgLink, context) {
    return Padding(
  ...
  GridView buildGrid(context) {
    return GridView.count(
      ...
      children: <Widget>[
        ...
        buildItem('GREY BEAST', "100,000", "assets/imgs/suit2.png", context),
        buildItem('BLUE DRAGON', "100,000", "assets/imgs/suit3.png", context),
        buildItem('GREY BEAST', "100,000", "assets/imgs/suit4.jpg", context),
        buildItem('GREY BEAST', "100,000", "assets/imgs/suit1.png", context),
      ],
    );
  }
}
